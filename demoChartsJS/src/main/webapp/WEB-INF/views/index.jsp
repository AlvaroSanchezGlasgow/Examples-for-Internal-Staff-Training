...
<body>
	<div class="container">
		<h1 class="display-1">Bars Chart</h1>
		<hr></hr>
		<nav class="avbar navbar-light" style="background-color: #e3f2fd;">
			...
			<div class="collapse navbar-collapse" id="navbarText">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item active"><a class="nav-link" href="/graphs">Bars
							Chart<span class="sr-only">(current)</span>
					</a></li>
					<li class="nav-item"><a class="nav-link" href="line">Line
							Chart</a></li>
					<li class="nav-item"><a class="nav-link" href="pie">Pie
							Chart</a></li>
				</ul>
		...
		<p></p>
		<p></p>
		<div id="mainGraph" style="margin: auto;">
	...
	var valueLabels = "<c:out value='${labels}'/>";
	
	//alert("before json.parse"+valueLabels);
	
	//var dataLabels = JSON.parse(valueLabels);
	
	//alert("after json.parse"+dataLabels);
	//alert(valueLabels);
